...
class LNetwork(nn.Module):
    ...
    def __init__(self, net_divisor=1):
        ...
        self.conv14 = Conv2d(ksize[0], ksize[1], 1)
        
        # Here comes upsample #1
        
        self.conv15 = Conv2d(ksize[1], ksize[2], 1)
        self.conv16 = Conv2d(ksize[2], ksize[3], 1)
        
        # Here comes upsample #2        
        
        self.conv17 = Conv2d(ksize[3], ksize[4], 1)
        self.conv18 = Conv2d(ksize[4], 1, 1)
    
    def forward(self, x):
        out = F.relu(self.conv14(x))
        ...
        out = torch.sigmoid(self.conv18(out))
...
class ColNet(nn.Module):
    ...
    def forward(self, x):
        ...
        return L_out, out, classification_out
